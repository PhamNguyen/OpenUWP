    ...
    public sealed class MenuListView : ListView
    {
        ...
        private void InvokeItem(object focusedItem)
        {
            ...
            if (!_splitViewHost.IsPaneOpen
                || item?.Content is SplitViewSeparator
                || item?.Content is SplitViewGroup
                || (_splitViewHost.DisplayMode != SplitViewDisplayMode.CompactOverlay && _splitViewHost.DisplayMode != SplitViewDisplayMode.Overlay))
                return;
